...
const API_CONFIG = {
  ...
  baseUrl: window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ...
    : 'https://proxy.tu-dominio.com/api/units/stock', // CAMBIAR por tu URL de producción
  ...
  authUrl: window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ...
    : 'https://proxy.tu-dominio.com/auth/external/token', // CAMBIAR por tu URL de producción
